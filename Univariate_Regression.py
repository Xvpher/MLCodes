...
gp.c('unset key')
gp.c('set border 2')
gp.c('set xtics ("X" 1, "Y" 2) scale 0.0')
...
gp.c('plot "plot_data1.dat" lc rgb "red" lw 10 with dots title "train data" , "plot_data2.dat" lc rgb "blue" lw 10 with dots title "test data"')
gp.c('plot "plot_data1.dat" lc rgb "red" lw 10 with dots title "train data" , "plot_data3.dat" lc rgb "green" lw 2 with lines title "Linear Regression Line" ')
gp.c('plot "plot_data2.dat" lc rgb "blue" lw 10 with dots title "test data" , "plot_data3.dat" lc rgb "green" lw 2 with lines title "Linear Regression Line" ')
gp.c('plot "plot_data1.dat" lc rgb "red" lw 10 with dots title "train data" , "plot_data4.dat" lc rgb "yellow" lw 2 with lines title "Polynomial Regression Line" ')
gp.c('plot "plot_data2.dat" lc rgb "blue" lw 10 with dots title "test data" , "plot_data4.dat" lc rgb "yellow" lw 2 with lines title "Polynomial Regression Line" ')
